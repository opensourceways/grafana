...
func TestPutAlert(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			expError: "invalid label set: invalid name \"alertname$\"",
		}, {
			...
			expError: "invalid annotations: invalid name \"msg$\"",
		}, {
			...
			expError: "at least one label pair required",
		}, {
			...
			expError: "start time must be before end time",
		},
	}
